            ...
            <div class="border border-dark bg-white">
              ...
              <div class="section-heading text-center mt-5">
                ...
                <hr/>
                  <!-- Log In-->
                  <br/>
                  <a class="text-primary" href="../index.php"><i class="fas fa-user-edit"></i> Log In</a>  
                <hr/>
              </div>
              <!-- Header -->
              <div class="mt-3 ml-5 mb-5 mr-5">
                ...
                <?php } ?>
                <!-- Error message -->
                <form action="kayitkontrol.php" method="POST" autocomplete="off">
                  <!-- Identity number -->
                  ...
                  <!-- Name -->
                   <div class="form-group mt-3 mb-3">
                    ...
                    <input class="form-control" type="text" maxlength="50" name="user_name" required/>
                  <div>
                  <!-- Name -->
                  <!-- Surname -->
                   <div class="form-group mt-3 mb-3">
                    <label for="surname-label">Surname</label>
                    <input class="form-control" type="text" maxlength="50" name="user_surname" required/>
                  <div>
                  <!-- Surname -->
                  <!-- Password -->
                  <div class="form-group mt-3 mb-3">
                    ...
                    <input type="checkbox" onclick="passvisibility()"><i>  Show Password</i>
                  <div>
                  <!-- Password -->

                  <hr/> 
                  <button type="submit" class="btn btn-block btn-success mt-3 mb-3" style="border-radius:5px;" value="Submit" name="submit" id="submit">Sign Up</button>
